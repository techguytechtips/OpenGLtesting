...
int main(void)
{
	...
	// create texture
	GLuint texture = LoadTexture2D("textures/brick.png", GL_RGBA ,GL_TEXTURE0, GL_NEAREST, GL_NEAREST, GL_REPEAT, GL_REPEAT);
